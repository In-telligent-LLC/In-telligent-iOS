...
/**
 Delegate Property for SMAMoatBaseVideoTracker and its subclasses to have to report ad event firings.
 */
@property (weak, nonatomic) id<SMAMoatVideoTrackerDelegate> videoTrackerDelegate;
